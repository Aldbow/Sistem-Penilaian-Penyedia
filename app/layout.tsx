  ...
  return (
    <html lang="id" suppressHydrationWarning>
      ...
      <body className={`${inter.variable} font-sans`} suppressHydrationWarning>
        <ThemeProvider defaultTheme="light" storageKey="kemnaker-theme">
              ...
              <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
                <div className="flex justify-between items-center py-3 lg:py-4">
                  ...
                  <nav className="flex items-center space-x-1 sm:space-x-2">
                    <a
                      href="/"
                      className="text-slate-700 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50 dark:hover:bg-slate-800 px-3 sm:px-4 py-2 rounded-xl text-xs sm:text-sm font-medium transition-all duration-300"
                    >
